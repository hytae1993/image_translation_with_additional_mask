...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    elif netG == 'attention_gan':
        net = ResnetGenerator_attentionGan(input_nc, output_nc, ngf, n_blocks=9)
    elif netG == 'additional_gan':
        net = ResnetGenerator_additionalGan(input_nc, output_nc, ngf, n_blocks=9)
    else:
...
class ResnetGenerator_attentionGan(nn.Module):
    # initializers
    def __init__(self, input_nc, output_nc, ngf=64, n_blocks=9):
        super(ResnetGenerator_attentionGan, self).__init__()
...
class ResnetGenerator_additionalGan(nn.Module):
    # initializers
    def __init__(self, input_nc, output_nc, ngf=64, n_blocks=9):
        super(ResnetGenerator_additionalGan, self).__init__()
        self.input_nc = input_nc
        self.output_nc = output_nc
        self.ngf = ngf
        self.nb = n_blocks
